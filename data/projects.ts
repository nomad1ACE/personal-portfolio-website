export const projects = [
  ...
  },
  {
    ...
    description:
      "A weather forecast application using React Native and OpenWeatherMap API. Provides current weather and 7-day forecasts with location-based services.",
    imageUrl:
      "/images/weather-forecast-app.jpg",
    githubUrl: "https://github.com/nomad1ACE/weather-forecast-app",
    technologies: ["React Native", "OpenWeatherMap API", "Expo", "AsyncStorage"],
    status: "Completed",
  },
  {
    id: "blog-cms",
